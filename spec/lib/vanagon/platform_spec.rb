  ...
  let(:platforms) do
    [
      ...
      },
      {
        ...
        :os_version                     => "5",
        :architecture                   => "i386",
        :output_dir                     => "products/el/5/i386",
        :output_dir_with_target         => "thing/el/5/i386",
        :output_dir_empty_string        => "/el/5/i386",
        :source_output_dir              => "products/el/5/SRPMS",
        :source_output_dir_with_target  => "thing/el/5/SRPMS",
