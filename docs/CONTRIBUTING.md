...
Third-party patches are essential for keeping vanagon great. We simply can't
access the huge number of platforms and myriad configurations for running
vanagon. We want to keep it as easy as possible to contribute changes that
...
````
    (CPR-1234) Make the example in CONTRIBUTING imperative and concrete
